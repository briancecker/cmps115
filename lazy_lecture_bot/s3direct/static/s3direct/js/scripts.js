(function(){
    ...
    var request = function(method, isUpload, url, data, headers, el, showProgress, cb) {
    ...
    var upload = function(file, data, el) {
        ...
        request('POST', true, url, form, {}, el, true, function(status, xml){
            disableSubmit(false)
            if (status !== 201) {
    ...
    var getUploadURL = function(e) {
        ...
        request('POST', false, url, form, headers, el, false, function(status, json){
